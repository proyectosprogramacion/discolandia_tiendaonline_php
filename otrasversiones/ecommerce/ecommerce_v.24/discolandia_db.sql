...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-12-2023 a las 13:13:40
...
CREATE TABLE `merchandising` (
  ...
  `merchand_imagen` varchar(255) NOT NULL
...
INSERT INTO `merchandising` (`merchand_id`, `merchand_title`, `merchand_category_id`, `merchand_price`, `merchand_quantitiy`, `merchand_description`, `merchand_short_desc`, `merchand_imagen`) VALUES
(1000, 'Extremoduro', 3, 15, 4, 'Extremoduro fue un grupo español de rock fundado por Roberto Iniesta en la ciudad extremeña de Plasencia en 1987 que se mantuvo activo hasta su disolución en diciembre de 2019 .', 'Camiseta de extremoduro', 'Extremoduro_camiseta.jpg '),
...
(5, 'Live In Concert The 24 Karat Gold Tour ', 4, 17.99, 9, 'Disco en directo de Stevie Nicks, la cantante de Fleetwood Mac. Contiene 17 canciones, entre ellas los hits \'Stand Back\', \'Rhiannon\', \'Landslide\', \'Gypsy\' y \'Edge of Seventeen\' . Este disco es la banda sonora de la película concierto del mismo título que  se estrenó en España el 21 de octubre.', 'Interprete Stevie Nicks ', 'disco_stevieNicks.jpg\r\n'),
(6, 'Midnights: Mahogany Edition', 2, 22.99, 11, 'Taylor Swift pública el 21/10 su nuevo álbum, \"Midnights\". Disponibles varias versiones y formatos: Todos con  13 canciones escritas en mitad de la noche: Las historias de 13 noches sin dormir.', 'Interprete Taylor Swift ', 'disco_taylorSwift.jpg'),
(7, 'LP - 2Vinilo Lost On You (Opaque Gold)', 4, 30.99, 8, 'El álbum \"Lost On You\" de LP se lanza en formato 2 LP vinilo en color dorado. El álbum fue publicado originalmente en 2016 y es un viaje conmovedor a través de las complejidades del amor y la nostalgia. Muestra la voz distintiva y emotiva de la artista en un contexto de influencias folk, rock y pop. ', 'Interprete LP', 'disco_lp.png');
...
--
ALTER TABLE `merchandising`
  MODIFY `merchand_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1007;
