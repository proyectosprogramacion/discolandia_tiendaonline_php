...
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Escritorio <small>Resumen de estadísticas</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <?php
                 if($_SERVER['REQUEST_URI'] == "/ecommerce/ecommerce_v.11/app/admin/" || $_SERVER['REQUEST_URI'] == "/ecommerce/ecommerce_v.11/app/admin.php")  {
